/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: eb32a60386cc9261e1ced836d918a289)
...
interface __BaseEnv_Env {
	...
	POSTHOG_HOST: "https://a.stopbars.com";
	AIRPORTDB_API_KEY: string;
	DIVISION_DATA_API_KEY: string;
	GITHUB_TOKEN: string;
	POSTHOG_API_KEY: string;
	VATSIM_CLIENT_SECRET: string;
	BARS: DurableObjectNamespace<import("./src/index").BARS>;
	BARS_RATE_LIMITER: DurableObjectNamespace<import("./src/index").RateLimiter>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "BARS" | "RateLimiter";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DEBUG" | "VATSIM_CLIENT_ID" | "POSTHOG_HOST" | "AIRPORTDB_API_KEY" | "DIVISION_DATA_API_KEY" | "GITHUB_TOKEN" | "POSTHOG_API_KEY" | "VATSIM_CLIENT_SECRET">> {}
}
